...
namespace Google.XR.ARCoreExtensions.Samples.PersistentCloudAnchors
{
    ...
    {
        public GameObject ThesisARObject;
        public Vector3 PositionOfARObjectRelativeToMap = new Vector3(0, 0, 0);
        /// <summary>
        ...
        private IEnumerator ResolveAnchor(string cloudId, ResolveCloudAnchorPromise promise)
        {
            ...
            if (result.CloudAnchorState == CloudAnchorState.Success)
            {
                ...
                InstatiateArObjectAtMapResolve(result.Anchor.transform);
            }
            else
            {
        ...
        //Instatiate Object in Realation to Mapposition
        private void InstatiateArObjectAtMapResolve(Transform anchorTransform)
        {
            Instantiate(ThesisARObject, anchorTransform);
            ThesisARObject.transform.position += PositionOfARObjectRelativeToMap;
        }
